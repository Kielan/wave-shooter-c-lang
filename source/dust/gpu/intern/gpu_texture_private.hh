...
inline size_t to_block_size(eGPUTextureFormat data_type)
{
  switch (data_type) {
    ...
    case GPU_RGBA8_DXT5:
      return 16;
    default:
      LIB_assert_msg(0, "Texture format is not a compressed format");
      return 0;
  }
}
...
inline size_t to_bytesize(eGPUDataFormat data_format)
{
  switch (data_format) {
    ...
    case GPU_DATA_2_10_10_10_REV:
      return 4;
    default:
      LIB_assert_msg(0, "Data format incorrect or unsupported");
      return 0;
  }
}
...
inline bool validate_data_format_mtl(eGPUTextureFormat tex_format, eGPUDataFormat data_format)
{
  switch (tex_format) {
    ...
    case GPU_RGB16F:
      return data_format == GPU_DATA_FLOAT;
    default:
      LIB_assert_msg(0, "Unrecognized data format");
      return data_format == GPU_DATA_FLOAT;
  }
}
